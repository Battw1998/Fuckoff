...
\033[38;5;46m##    ##  \033[37;1m#######  \x1b[38;5;196m##         \033[33;1m#######  \033[34;1m##     ##                                                
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} NUPUR QUEEN             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}NUPUR QUEEN            {N}{M} ║
      {H}║{M}[{H}•{M}] GITHUB    : {H}NUPUR-CYBER-XD{N}       {H}   ║
      {M}║{M}[{H}•{M}] STATUS    : {H}NUPUR -XD{P}     {N}  {H}        ║
...
def main():
    os.system('clear')
    print('\n\n\n [😅] FUCK NUPUR PUSSY & POM POM  - XYLON')
    time.sleep(4)
    os.system('clear')
    print(lol)
    print(f' ')
